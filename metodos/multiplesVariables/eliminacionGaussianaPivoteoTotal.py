...
def recolectarDatos():
    ...
    file = open("GaussianaPivoteoTotal.txt" , "w")
    eliminacionGaussianaPivoteoTotal(A, n, marcas, file)

def eliminacionGaussianaPivoteoTotal(A,n,marcas, file):
    print("\n    MATRIZ ORIGINAL A")
    file.write("\n    MATRIZ ORIGINAL A \n")
    ...
    print(tabulate(A, tablefmt='fancy_grid',floatfmt=".14f"))
    file.write(tabulate(A, tablefmt='grid',floatfmt=".14f"))
    sustitucionRegresiva(A,n,marcas, file)
...
def sustitucionRegresiva(A,n,marcas, file):
