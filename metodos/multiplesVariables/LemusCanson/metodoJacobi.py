...
def recolectarDatos():
    ...
    for i in range(n):
        ...
        fila = str(input("Ingrese los valores de la fila " + str(i+1) + " separados por espacio y además el termino independientes: "))  #El usuario ingresa los coeficientes de la matriz
        valores = fila.split(" ")
